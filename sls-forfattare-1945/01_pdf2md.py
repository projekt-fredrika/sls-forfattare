...
path = "/Users/robertsilen/Dropbox/Projekt Fredrika/Projekt Fredrika r.f./Forfattare/1945/Suomen kirjailijat 1945-1980.pdf"
pages = "13-827"
skip_pages = "433-480"
page_limit = -1
            ...
            if current_line:
                ...
                if previous_line_height is not None:
                    ...
                    if is_included_header(line_text, inclusion_patterns):
                        ...
                        is_header = (avg_height > 8.6 and distance > 24 and 
